...
server 'ld4p_dev_zookeeper1', user: 'ubuntu', roles: %w[ubuntu zookeeper]
server 'ld4p_dev_zookeeper2', user: 'ubuntu', roles: %w[ubuntu zookeeper]
server 'ld4p_dev_zookeeper3', user: 'ubuntu', roles: %w[ubuntu zookeeper]
...
server 'ld4p_dev_kafka1', user: 'ubuntu', roles: %w[ubuntu kafka]
server 'ld4p_dev_kafka2', user: 'ubuntu', roles: %w[ubuntu kafka]
server 'ld4p_dev_kafka3', user: 'ubuntu', roles: %w[ubuntu kafka]
