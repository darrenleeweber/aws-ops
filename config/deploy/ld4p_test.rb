...
server 'ld4p_test_zookeeper1', user: 'ubuntu', roles: %w[ubuntu zookeeper]
server 'ld4p_test_zookeeper2', user: 'ubuntu', roles: %w[ubuntu zookeeper]
server 'ld4p_test_zookeeper3', user: 'ubuntu', roles: %w[ubuntu zookeeper]
...
server 'ld4p_test_kafka1', user: 'ubuntu', roles: %w[ubuntu kafka]
server 'ld4p_test_kafka2', user: 'ubuntu', roles: %w[ubuntu kafka]
server 'ld4p_test_kafka3', user: 'ubuntu', roles: %w[ubuntu kafka]
