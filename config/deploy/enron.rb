...
server 'enron_zookeeper1', user: 'ubuntu', roles: %w[ubuntu zookeeper]
server 'enron_zookeeper2', user: 'ubuntu', roles: %w[ubuntu zookeeper]
server 'enron_zookeeper3', user: 'ubuntu', roles: %w[ubuntu zookeeper]
...
server 'enron_kafka1', user: 'ubuntu', roles: %w[ubuntu kafka]
server 'enron_kafka2', user: 'ubuntu', roles: %w[ubuntu kafka]
server 'enron_kafka3', user: 'ubuntu', roles: %w[ubuntu kafka]
