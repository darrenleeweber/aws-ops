...
describe RedhatHelper do
  let(:current_path) { 'current_path' }
  let(:redhat_helper) { RedhatHelper.new(current_path) }

  shared_examples 'a_yum_command' do
    it 'is a yum command' do
      expect(result).to be_an String
      expect(result).to include 'yum'
    end
  end
  ...
  describe '#new' do
    it 'works' do
      ...
      result = RedhatHelper.new(current_path)
      expect(result).not_to be_nil
    end
  end

  describe '#yum_update' do
    let(:result) { redhat_helper.yum_update }
    it_behaves_like 'a_yum_command'
  ...
  describe '#yum_upgrade' do
    let(:result) { redhat_helper.yum_upgrade }
    it_behaves_like 'a_yum_command'
    it_behaves_like 'logs_output'
    it 'calls upgrade' do
  ...
  describe '#yum_auto_remove' do
    let(:result) { redhat_helper.yum_auto_remove }
    it_behaves_like 'a_yum_command'
    it_behaves_like 'logs_output'
    it 'calls auto_remove' do
      expect(result).to include 'autoremove'
    end
  end

  # describe '#build' do
  #   let(:result) { redhat_helper.build }
  #   it_behaves_like 'logs_output'
  ...
  #
  # describe '#ctags' do
  #   let(:result) { redhat_helper.ctags }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.docker_add_user }
  ...
  #   let(:result) { redhat_helper.docker_ce }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.docker_hello_world }
  ...
  #
  # describe '#gradle' do
  #   let(:result) { redhat_helper.gradle }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.java_oracle_license }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.java_oracle_repository }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.java_7_oracle }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.java_8_oracle }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.kafka_bin(kafka_ver) }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.log_path_files }
  #   it 'calls find' do
  ...
  #
  # describe '#maven' do
  #   let(:result) { redhat_helper.maven }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.network_tools }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.zookeeper }
  #   it_behaves_like 'logs_output'
  ...
  #   let(:result) { redhat_helper.zookeeper_upgrade }
  #   it_behaves_like 'a_yum_command'
  #   it_behaves_like 'logs_output'
